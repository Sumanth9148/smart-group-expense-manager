...
from app.persistence.mysql.settlement_repo_mysql import SettlementRepositoryMySQL
...
def build_services():
    ...
    # Load DB and create a DB helper
    ...
    settlement_repo = SettlementRepositoryMySQL(db)
